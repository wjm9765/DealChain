...
public class TestController {
    ...
    private final com.dealchain.dealchain.domain.AI.service.FlaskApiService flaskApiService;
    ...
    public void testApiGatewayEndpoint() {
        ...
        try {
            String responseJson = flaskApiService.sendPostRequest(hardcodedChatLog);
